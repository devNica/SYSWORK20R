...
const Navbar = ({logout, history, user}) =>{
    ...
    const userLink = (
        <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
                <a className="nav-link font-weight-bold text-white" href="null" onClick={handleLogout}>LOGOUT</a>
            </li>
    ...
    const guestLink = (
        <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
                <Link className="nav-link font-weight-bold text-white" to="/signin">SIGNIN</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link font-weight-bold text-white" to="/signin">SIGNUP</Link>
            </li>
